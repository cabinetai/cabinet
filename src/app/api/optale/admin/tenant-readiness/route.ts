...
import { buildOptaleTenantReadinessPayload } from "@/lib/optale/tenant-readiness";
...
export async function GET(request: NextRequest) {
  ...
  try {
    const payload = await buildOptaleTenantReadinessPayload(auth.identity, {
    ...
    return NextResponse.json(
      { error: "OptaleTenantReadinessFailed", message },
